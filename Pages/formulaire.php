...
<main id="formulaire" class="Inscription">
    <h1><?php echo secu($messages['PageIns']) ?></h1>
    <p><?php echo secu($info)?></p>
    <div class="containerForm">
        <form method="post" action="AjoutProfil.php" id="inscription">
            <label for="nom"><?php echo secu($messages['nom']) ?> :</label><br/>
            <input type="text" id="nom" name="NomInsc" placeholder="<?php echo secu($messages['votre'] . $messages['nom']) ?>" autocomplete="off" required><br/>

            <label for="prenom"><?php echo secu($messages['prenom']) ?> :</label><br/>
            <input type="text" id="prenom" name="PrenomInsc" placeholder="<?php echo secu($messages['votre'] . $messages['prenom']) ?>" autocomplete="off" required><br/>

            <label for="mail"><?php echo secu($messages['mail']) ?> :</label><br/>
            <input type="email" id="mail" name="EmailInsc" placeholder="<?php echo secu($messages['votre'] . $messages['mail']) ?>" autocomplete="off" required><br/>

            <label for="password"><?php echo secu($messages['mdp']) ?> :</label><br/>
            <input type="password" id="password" name="PasswordInsc" placeholder="<?php echo secu($messages['votre'] . $messages['mdp']) ?>" autocomplete="off" pattern="(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}" required><br/>

            <label for="num"><?php echo secu($messages['numero']) ?> :</label><br/>
            ...
            <label for="adresse"><?php echo secu($messages['adresse']) ?> :</label><br/>
            <input type="text" id="adresse" name="AdresseInsc" placeholder="<?php echo secu($messages['votre'] . $messages['adresse']) ?>" autocomplete="off" required><br/>

            <input type="submit" id="submit" value="<?php echo secu($messages['Sub']) ?>"><br/>

            <p><?php echo secu($messages['AlrAccount']) ?><a href="connexion.php"><?php echo secu($messages['connect']) ?></a></p>
        </form>
    </div>
</main>
<footer id="footer">
